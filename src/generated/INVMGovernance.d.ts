...
interface INVMGovernanceInterface extends ethers.utils.Interface {
  functions: {
...
export class INVMGovernance extends BaseContract {
  ...
  interface: INVMGovernanceInterface;
