...
interface INVMGovernanceEventsInterface extends ethers.utils.Interface {
  functions: {};
...
export class INVMGovernanceEvents extends BaseContract {
  ...
  interface: INVMGovernanceEventsInterface;
