...
interface NVMGovernanceImplementationInterface extends ethers.utils.Interface {
  functions: {
...
export class NVMGovernanceImplementation extends BaseContract {
  ...
  interface: NVMGovernanceImplementationInterface;
  ...
  functions: {
    ...
    initialize(
      ...
      _proposalThresholdPercentage: BigNumberish,
      _quorumVotesPercentage: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    setProposalThresholdPercentage(
      _newProposalThresholdPercentage: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
