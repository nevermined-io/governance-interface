...
interface NVMMintableTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class NVMMintableToken extends BaseContract {
  ...
  interface: NVMMintableTokenInterface;
