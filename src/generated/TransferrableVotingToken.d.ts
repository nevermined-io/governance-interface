...
interface TransferrableVotingTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class TransferrableVotingToken extends BaseContract {
  ...
  interface: TransferrableVotingTokenInterface;
