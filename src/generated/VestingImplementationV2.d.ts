...
interface VestingImplementationV2Interface extends ethers.utils.Interface {
  functions: {
...
export class VestingImplementationV2 extends BaseContract {
  ...
  interface: VestingImplementationV2Interface;
